...
$pageTitleForTopbar = $data['title'] ?? ($isEditMode ? 'Edit Medicine' : 'Add New Medicine');
$welcomeMessageForTopbar = $isEditMode ? 'Update the medicine details below.' : 'Enter details for the new medicine.';
$currentUrl = $_GET['url'] ?? ($isEditMode ? 'admin/editMedicine' : 'admin/createMedicine');
...
.dashboard-sidebar-cutie {
        ...
        .form-container-admin-styled-cutie legend { font-size: 18px; font-weight: 600; color: #0a783c; padding: 0 10px; margin-left: 10px; }
